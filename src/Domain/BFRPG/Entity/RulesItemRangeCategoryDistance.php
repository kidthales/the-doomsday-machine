 ...
 */
#[ORM\Entity(repositoryClass: RulesItemRangeCategoryDistanceRepository::class)]
#[ORM\Table(name: 'rules_item_range_category_distance')]
#[ORM\UniqueConstraint(
    name: 'UNIQ_IDENTIFIER_RULES_ITEM_RANGE_CATEGORY_DISTANCE_ITEM_ID_RANGE_CATEGORY_ID',
    columns: ['rules_item_id', 'rules_range_category_id']
)]
class RulesItemRangeCategoryDistance
{
    public const string GROUP_LIST = 'rules_item_range_category_distance_list';
    public const string GROUP_DETAIL = 'rules_item_range_category_distance_detail';
     ...
     * @var RulesItem|null
     */
    #[ORM\ManyToOne(targetEntity: RulesItem::class, inversedBy: 'rules_item_range_category_distance')]
    #[ORM\JoinColumn(name: 'rules_item_id', onDelete: 'CASCADE')]
    #[Assert\NotNull]
    #[Groups([self::GROUP_DETAIL])]
    private ?RulesItem $item = null;

    /**
     * @var RulesRangeCategory|null
     */
    #[ORM\ManyToOne(targetEntity: RulesRangeCategory::class, inversedBy: 'rules_item_range_category_distance')]
     ...
     */
    #[ORM\ManyToOne(targetEntity: RulesSource::class, inversedBy: 'rules_item_range_category_distance')]
     ...
     */
    public function getItem(): ?RulesItem
    {
        return $this->item;
    }
    ...
    /**
     * @param RulesItem $item
     * @return $this
     */
    public function setItem(RulesItem $item): static
    {
        $this->item = $item;
        return $this;
    }
