...
namespace App\Command\Jabronibetz\Entity\Football\Competition;
...
#[AsCommand(
    ...
    aliases: [
        'app:jabronibetz:entity:football:competition:new',
        'app:jbetz:ent:footy:cmp:create',
        'app:jbetz:ent:footy:cmp:new'
    ],
)]
