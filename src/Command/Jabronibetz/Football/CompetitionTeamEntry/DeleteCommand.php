 ...
 */
#[AsCommand(
    name: 'app:jabronibetz:football:competition-team-entry:delete',
    description: 'Delete a football competition team entry',
    aliases: ['app:jbetz:footy:cmp-team-entry:delete'],
)]
