 ...
 */
#[AsCommand(
    name: 'app:jabronibetz:football:team:read',
    description: 'Read a football team',
    aliases: ['app:jbetz:footy:team:read'],
)]
final class ReadCommand extends Command
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->setHelp(
                <<<'HELP'
                The <info>%command.name%</info> command allows you to read a <comment>football team</comment>
    ...
    protected function interact(InputInterface $input, OutputInterface $output): void
    {
        ...
        if ($input->getArgument('id') === null) {
            $choices = $this->footballTeamRepository->findAllChoices();
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->title('Jabronibetz: Football Team Read');
