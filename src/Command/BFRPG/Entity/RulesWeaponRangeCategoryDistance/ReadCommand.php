 ...
 */
#[AsCommand(
    name: 'app:bfrpg:entity:rules-weapon-range-category-distance:read',
    description: 'Read a rules weapon range category distance',
)]
final class ReadCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->title('BFRPG: Read Rules Weapon Range Category Distance');

        try {
            $io->definitionList(...$this->definitionListConverter->convert(
                $this->parseRulesWeaponRangeCategoryDistanceIdArgument($input, 'id'),
                [
