 ...
 */
#[AsCommand(
    name: 'app:bfrpg:entity:rules-armor:delete',
    description: 'Delete a rules armor'
)]
final class DeleteCommand extends Command
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->setHelp(
                <<<'HELP'
                The <info>%command.name%</info> command allows you to delete a <comment>rules armor</comment>
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->title('BFRPG: Delete Rules Armor');
        ...
        try {
            ...
            if ($input->isInteractive()) {
                ...
                if (!$io->confirm('Delete rules armor?')) {
            ...
            $this->entityManager->remove($armor);
            $this->entityManager->flush();

            $io->success(sprintf('Rules armor with id %d has been deleted.', $id));
        } catch (Throwable $e) {
            $this->logThrowable($e);
