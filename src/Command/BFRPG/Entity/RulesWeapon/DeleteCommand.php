 ...
 */
#[AsCommand(
    name: 'app:bfrpg:entity:rules-weapon:delete',
    description: 'Delete a rules weapon'
)]
final class DeleteCommand extends Command
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->setHelp(
                <<<'HELP'
                The <info>%command.name%</info> command allows you to delete a <comment>rules weapon</comment>
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->title('BFRPG: Delete Rules Weapon');
        ...
        try {
            ...
            if ($input->isInteractive()) {
                ...
                if (!$io->confirm('Delete rules weapon?')) {
            ...
            $io->success(sprintf('Rules weapon with id %d has been deleted.', $id));
        } catch (Throwable $e) {
            $this->logThrowable($e);
