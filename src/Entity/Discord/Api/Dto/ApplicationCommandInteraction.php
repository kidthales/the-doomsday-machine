 ...
 */
class ApplicationCommandInteraction extends AbstractInteraction
{
    /**
     ...
     * @param ApplicationCommandData $data Interaction data payload.
    ...
    public function __construct(
        ...
        public ApplicationCommandData $data,
        ?Guild                        $guild = null,
