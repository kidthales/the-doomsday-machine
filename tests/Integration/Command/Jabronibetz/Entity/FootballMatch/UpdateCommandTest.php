...
use App\Command\Jabronibetz\Entity\FootballMatch\UpdateCommand;
...
final class UpdateCommandTest extends KernelTestCase
{
    ...
    public function it_fails_when_football_match_id_not_found(): void
    {
        ...
        $appTester->run(
            [
                'command' => 'app:jabronibetz:entity:football-match:update',
                'id' => -1,
            ]
        );
        ...
        $this->assertStringContainsString(
            'App\Domain\Jabronibetz\Entity\FootballMatch not found for id -1',
