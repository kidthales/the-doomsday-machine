...
use App\Command\Jabronibetz\Entity\FootballTeam\UpdateCommand;
...
final class UpdateCommandTest extends KernelTestCase
{
    ...
    public function it_fails_when_football_team_id_not_found(): void
    {
        ...
        $appTester->run(
            [
                'command' => 'app:jabronibetz:entity:football-team:update',
                'id' => -1,
            ]
        );
        ...
        $this->assertStringContainsString(
            'App\Domain\Jabronibetz\Entity\FootballTeam not found for id -1',
