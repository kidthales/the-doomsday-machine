...
final class Version20260616020045 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Add/remove the seed column to/from the football_competition_team_entry table.';
    }

    public function up(Schema $schema): void
    {
        $this->addSql('ALTER TABLE football_competition_team_entry ADD COLUMN seed SMALLINT DEFAULT NULL');
    }
