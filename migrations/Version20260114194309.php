...
final class Version20260114194309 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Footy Stats: England Championship 2025/26';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE VIEW footy_stats_england_championship_202526_team_standing AS
        ...
        $this->addSql(<<<'SQL'
            ...
            SELECT team_name,
                   goals_for_per_game / (SELECT AVG(goals_for_per_game) FROM footy_stats_england_championship_202526_team_standing)         AS attack,
                   goals_against_per_game / (SELECT AVG(goals_against_per_game) FROM footy_stats_england_championship_202526_team_standing) AS defense
        ...
        $this->addSql(<<<'SQL'
            ...
            SELECT home_team_name,
                   away_team_name,
                   (SELECT AVG(goals_for_per_game) FROM footy_stats_england_championship_202526_home_team_standing) * h.attack * a.defense AS home_team_xg,
                   (SELECT AVG(goals_for_per_game) FROM footy_stats_england_championship_202526_away_team_standing) * a.attack * h.defense AS away_team_xg,
                   timestamp,
                   extra
            FROM footy_stats_england_championship_202526_match AS m
                INNER JOIN footy_stats_england_championship_202526_team_strength AS h ON m.home_team_name = h.team_name
                INNER JOIN footy_stats_england_championship_202526_team_strength AS a ON m.away_team_name = a.team_name
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            DROP VIEW footy_stats_england_championship_202526_team_standing;
        SQL
        );
